...
import static developmentutilities.TakeEvidence.HighlightElement;
import static developmentutilities.TakeEvidence.takeScreenshot;
...
public class HomePage {
	...
	public static void clicSearchButton() {
		WebElement element = wait.until(ExpectedConditions.elementToBeClickable(BUTTON_SEARCH_XPATH));
		HighlightElement(driver, element);
		takeScreenshot(driver,BROWSER);
		element.click();	
	}
