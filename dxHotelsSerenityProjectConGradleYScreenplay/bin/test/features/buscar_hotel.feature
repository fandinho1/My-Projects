...
Característica: Realizar busqueda de hoteles
  ...
  Esquema del escenario: Como usuario quiero realizar una busqueda de hoteles usando todos los filtros para ver los
  hoteles disponibles y debo encontrar resultados
